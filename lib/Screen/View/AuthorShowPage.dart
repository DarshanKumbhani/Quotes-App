...
class AuthorShowPage extends StatefulWidget {
  const AuthorShowPage({Key? key}) : super(key: key);

  @override
  State<AuthorShowPage> createState() => _AuthorShowPageState();
}

class _AuthorShowPageState extends State<AuthorShowPage> {
            ...
            () => Stack(
              ...
              children: [
                Container(
                  ...
                  child: Image.network(
                    "${homeController.colorList2[homeController.inde.value].image}",
                    fit: BoxFit.cover,
                  ),
                ),
                Container(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${homeController.colorList2[homeController.inde.value].quote}",
                      ...
                      Text(
                        "- ${homeController.colorList2[homeController.inde.value].name}",
                        textAlign: TextAlign.center,
                        style: homeController.text.value == 0
                            ? GoogleFonts.satisfy(
                                color: Colors.white, fontSize: 25)
                      ...
                      IconButton(
                        onPressed: () {
                          Clipboard.setData(
                            ClipboardData(
                                text: homeController
                                    .colorList2[homeController.inde.value]
                                    .quote),
                          );
                        },
                        icon: Icon(
